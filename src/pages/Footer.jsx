  ...
  return (
    <div className='bg-black max-w-screen-2xl px-6 py-10 md:px-16 lg:px-40 justify-between font-primary'>
        ...
        <div className='text-left mb-5 text-white'>
            <h3 className='lg:text-2xl text-red-500 lg:mb-3 mb-1 text-lg'>Suvidha Foundation (Suvidha Mahila Mandal)</h3>
            <p className='mb-1'> Office Headquarters - </p>
            <p className='text-red-500 mb-2 '> Nagpur Headquarter:</p>
<p className='mb-2'>Suvidha Foundation, Motghare Bhavan, Ward No. 4, Santnagar, Annamod, Near Water Tank, Khaperkheda, Saoner, Nagpur, Maharashtra, India Pincode - 441102
</p>
...
<p>Vazhra Nirman Pushpak, C Block 701, 500090, Hyderabad</p>
        ...
        <div className='text-left mb-5 text-white flex flex-col px-10'>
            ...
            <a href='https://suvidhafoundationedutech.org/Themes/doc/suvidha_darpan_portal_registration.pdf' className='hover:text-red-300 mb-2'>Suvidha Darpan Registration</a>
            <a href='https://suvidhafoundationedutech.org/Themes/doc/suvidha_pan_card.pdf' className='hover:text-red-300 mb-2'>Suvidha Pan Card</a>
        </div>
        <div className='text-left mb-5 text-white flex flex-col '>
            ...
            <div className='text-left text-white justify-between flex'>
                <p className='text-white'>© Suvidha Foundation (Suvidha Mahila Mandal), All Right Reserved.</p>
                <p className='text-white'>By <Link to='/' className='hover:text-red-300'>Suvidha Foundations</Link></p>
            </div>
